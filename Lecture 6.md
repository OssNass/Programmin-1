...
2. إذا كان الشرط محققًا → يتم تنفيذ جسم الحلقة.
3. بعد التنفيذ يعود ويفحص الشرط مرة أخرى.
4. تستمر العملية حتى يصبح الشرط خاطئًا.
...
5. تحديد إذا كان العدد أوليا prime number
