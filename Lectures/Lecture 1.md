---
theme: ../themes/slidev-theme-penguin-rtl
colorSchema: light
class: text-center
...
- لكن إذا أردنا أن نحدد نقطة بداية، نلجأ عادة لتحديدها مع تشارلز بابج
---
...
# تعريف الحاسب
## لمحة تاريخية
- لم يتوقف تطور الحاسب مطلقاً، إذ كان لتطوير الترانزستور من قبل ويليام شوتكي دور كبير في الحجم واستهلاك الكهرباء
- كما كان لذلك دور أساسي في تطوير مفهوم الدارات المتكاملة Integrated Circuit التي تضع كل الترانزستورات على قطعة واحدة (كرت الـ SD المستخدم ضمن الموبايل هو دارة متكاملة IC)
...
- C
	- ماتزال تستخدم هذه اللغة حتى اليوم مع أنّ  عملية التطوير تمت في الثمانينيات من القرن الماضي
...
# ماهي البرمجة
- الحاسب لا يفهم البرنامج كتلة واحدة
- إنما يفهمه على أنه مجموعة من التعليمات المتتالية التي يعمل على تنفيذها
- لكي نوضح هذه التعليمات يجب علينا كتابتها بالاعتماد لغة خاصة تسمى لغة الآلة
...
# لغة البرمجة
## التعريف
- هي لغة خاصة تكون مكونة من مجموعة من الكلمات المحجوزة وتتبع نظام قواعدي ذو أساس رياضي تستخدم لكتابة البرامج
- كلمات محجوزة؟
- نظام قواعدي ذو أساس رياضي؟ ما دخل الرياضيات بالموضوع؟
	- الرياضيات أساسية في البرمجة إذ إن كل لغات البرمجة توصف بالاعتماد على النموذج القواعدي خارج السياق (مقرر الأتومات واللغات الصورية، السنة الثالثة)
	- كما أن الاحتمالات والإحصاء أساس الذكاء الصنعي
...
- في لغات البرمجة لا يوجد تفصيل مثل هذا، لكن يمكننا تقسيم الجمل فيها إلى نوعين
	...
	- جملة مساعدة تعمل على تضمين
 مكاتب مختلفة كي لا نعيد اختراع العجلة
---
...
- أول سطرين هما جملة مساعدة (تعليمات إدراج وتحديد عمل)
	- #include هو أمر إدراج الملف الرأسي iostream
...
## البنية الأساسية
### آلية التحويل
- قلت مسبقًا "أما الزميل الذي يترجم فهو المترجم Compiler أو المفسر Interpreter"
	...
	- توجد آليتان أساسيتان لتحويل البرامج المكتوبة بلغات البرمجة إلى لغة آلة
		- الترجمة Compiling
			- لنتصور أنك تريد ترجمة كتاب من لغة للغة؟
				- مالذي تفعله بكل بساطة تقوم أولًا بالتحويل من اللغة المصدر إلى اللغة الهدف
...
- مالمقصود بالمترجم والمفسر؟
	- توجد آليتان أساسيتان لتحويل البرامج المكتوبة بلغات البرمجة إلى لغة آلة
		...
		- التفسير Interpreting
			...
			- المفسر على تحويل البرنامج كل جملة (تعليمة) على حدىً إلى لغة الآلة وتنفيذها بعد التأكد من صحتها اللغوية والقواعدية
...
- Compile Vs Interpret أيهما أفضل؟
	- لا يمكن القول أن نموذج أفضل من الأخر لكل منهما ميزات ومساوئ
	- المترجم Compiled
		- المحاسن
			- سرعة في التنفيذ لأن عملية التحقق القواعدي تمت مسبقًا
			- حجم صغير لأننا لا نحتاج إلا إلى الملف التنفيذي وممكن بعض الملفات الأخرى
		- المساوئ
			- زمن الترجمة قد يكون طويلًا
...
- Compile Vs Interpret أيهما أفضل؟
	...
	- المفسر Interpret
		...
		- المساوئ
			...
			- بطء في التنفيذ لأن عملية التحقق من الصحة تتم أثناء تنفيذ البرنامج
---
...
- ماهي المصفوفات
	- مجموعة من الحجر الذاكرية المتجاورة تخزن نفس النمط بقيم مختلفة (علامات الطلاب مثلًا)

</div>
<div>

- ماهي المؤشرات
	- نمط خاص من المتحولات تخزن عنوان المتحول عوضًا عن القيمة
- ماهي الأغراض
